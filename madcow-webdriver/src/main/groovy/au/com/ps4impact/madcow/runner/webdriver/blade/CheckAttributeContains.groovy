 ...
 */
class CheckAttributeContains  extends WebDriverBladeRunner {
	...
	public void execute(WebDriverStepRunner stepRunner, MadcowStep step) {
		...
		step.blade.parameters.each { String attributeName, String expectedValue ->
			...
			if ( ! actualValue.contains(expectedValue)) {
				step.result = MadcowStepResult.FAIL("Attribute: '$attributeName' Expected to contain: '$expectedValue', Actual value: '$actualValue'");
			}
		}
	}

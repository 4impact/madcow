...
/**
 * This class is the VerifyNotExists madcow operation which checks that an element exists on the page
 *
 * @author Paul Bevis
 */
class VerifyNotExists extends WebDriverBladeRunner {
    ...
    public void execute(WebDriverStepRunner stepRunner, MadcowStep step) {
        ...
        try {
            ...
            if (element == null) {
                ...
                step.result = MadcowStepResult.FAIL("The element does exist")
            }
        } catch (Exception) {
            step.result = MadcowStepResult.PASS("The element does not exist")
        }

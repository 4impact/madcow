 ...
 * @author Paul Bevis
 */
class VerifySelectFieldContains extends WebDriverBladeRunner {
    ...
    public void execute(WebDriverStepRunner stepRunner, MadcowStep step) {
        ...
        if (bNotMatched) {
            step.result = MadcowStepResult.FAIL('Select field does not contain the specified data');
            step.result.detailedMessage = "Select contains ${presentList}, not matched data ${notMatchList}";
        } else {

...
/**
 * This class is so that you can Check an elements Class values
 *
 * @author Tom Romano
 */

class HasClass extends WebDriverBladeRunner {
    ...
    public void execute(WebDriverStepRunner stepRunner, MadcowStep step) {
        ...
        if (foundMatch) {
            ...
            step.result = MadcowStepResult.FAIL("Expected Classes: '${expectedValues.toList()}', Present Classes: '${elementClasses.toList()}'");
        }
    }

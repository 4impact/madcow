...
class CountRowsEqualsTest extends GroovyTestCase {
    ...
    void testCountByHtmlId() {
        ...
        blade = new GrassBlade('theTableMapping.table.countRows.equals = 5', testCase.grassParser);
        verifyCountRow(blade, true);

        // incorrect number of rows
        blade = new GrassBlade('theTableMapping.table.countRows.equals = 1', testCase.grassParser);
        verifyCountRow(blade, false);
    }
    ...
    void testMappingSelectorInvalidRequired() {
        try {
            ...
            assertFalse(countRowsEquals.isValidBladeToExecute(blade));

...
class CountRowsLessThanTest extends GroovyTestCase {
    ...
    void testCountByHtmlId() {
        ...
        blade = new GrassBlade('theTableMapping.table.countRows.lessThan = 7', testCase.grassParser);
        verifyCountRow(blade, true);

        // incorrect number of rows
        blade = new GrassBlade('theTableMapping.table.countRows.lessThan = 4', testCase.grassParser);
        verifyCountRow(blade, false);
    }
    ...
    void testMappingSelectorInvalidRequired() {
        try {
            ...
            assertFalse(countRowsLessThan.isValidBladeToExecute(blade));
